...
const SYNONYMES: Record<string, string[]> = {
  ...
  facture: ['invoice'], factures: ['invoice'], brouillon: ['draft'], annule: ['void', 'cancel', 'revoke'], annuler: ['void', 'cancel', 'revoke'], archive: ['archive', 'unarchive'], archivee: ['archive', 'unarchive'], sors: ['unarchive'], desarchive: ['unarchive'], rembourse: ['refund'], remboursement: ['refund'], paiement: ['payment'], paiements: ['payment'], partiel: ['payment', 'partial'], comptant: ['payment'], recurrente: ['recurring'], recurrent: ['recurring', 'recurrence'], recurrentes: ['recurring'], recurrence: ['recurrence'], recurrents: ['recurring', 'recurrence'], lien: ['payment_request', 'link'], relance: ['reminder', 'automation'], relances: ['reminder', 'automation'], rappel: ['reminder', 'automation'], message: ['message'], carte_enregistree: ['card'], enregistree: ['card', 'file'], enregistrees: ['card', 'file'],
