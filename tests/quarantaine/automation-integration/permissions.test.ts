...
describe.skipIf(!DISPONIBLE)('T8 — permissions (staging)', () => {
  ...
  it('T8.1 — ROUGE ATTENDU (F4/F15, M1) : un technicien ne peut pas faire marquer une facture payée par le moteur', async () => {
  ...
  it('T8.2 — ROUGE ATTENDU (F4/F18, M1) : un technicien ne peut pas détourner les confirmations vers son numéro', async () => {
  ...
  it('T8.4 — ROUGE ATTENDU (M7) : un membre dont l’adhésion est inactive ne peut pas appeler un hook d’événement', async () => {
