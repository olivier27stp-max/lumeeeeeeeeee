...
describe.skipIf(!DISPONIBLE)('T12 / T6 — coût et volume (staging)', () => {
  ...
  it('T12.4 — corrigé (F6, M2) : org A en pause → aucun envoi pour A, B continue', async () => {
  ...
  it('T12.5 — corrigé (F6, M2) : dry-run sur A → log « aurait envoyé », aucun appel Twilio', async () => {
