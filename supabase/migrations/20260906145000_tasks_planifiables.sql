...
-- with (security_invoker = true) : OBLIGATOIRE. CREATE OR REPLACE VIEW
-- réinitialise les options ; sans cette clause la vue tourne avec les droits
-- de postgres et contourne la RLS de tasks (fuite constatée en prod le
-- 2026-09-06, refermée par 20260906160000).
