    ...
    <>
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 h-10 px-5 bg-[#d8d0c2] text-black hover:bg-[#cabfad] dark:bg-primary dark:text-white dark:hover:bg-primary-hover rounded-lg text-[14px] font-medium active:scale-[0.98] transition-all"
        >
