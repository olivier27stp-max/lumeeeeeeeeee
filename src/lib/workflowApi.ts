...
export const TRIGGER_DEFS: Record<TriggerType, { label: string; labelFr: string; icon: string; category: string }> = {
  ...
  quote_created:        { label: 'Quote Created',         labelFr: 'Devis créé',              icon: 'FilePlus',    category: 'Sales' },
  quote_sent:           { label: 'Quote Sent',            labelFr: 'Devis envoyé',            icon: 'Send',        category: 'Sales' },
  quote_approved:       { label: 'Quote Approved',        labelFr: 'Devis approuvé',          icon: 'CheckCircle2', category: 'Sales' },
  quote_declined:       { label: 'Quote Declined',        labelFr: 'Devis refusé',            icon: 'XCircle',     category: 'Sales' },
  quote_converted:      { label: 'Quote Converted to Job', labelFr: 'Devis converti',         icon: 'ArrowRight',  category: 'Sales' },
