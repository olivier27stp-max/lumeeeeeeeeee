...
const COMMAND_DEFINITIONS: CommandDefinition[] = [
  ...
  { command: 'pipeline', path: '/pipeline', aliases: ['pipeline', 'leads'], label: 'Open pipeline' },
  { command: 'quotes', path: '/quotes', aliases: ['quotes', 'estimates'], label: 'Open quotes' },
  { command: 'invoices', path: '/invoices', aliases: ['invoices', 'billing', 'factures'], label: 'Open invoices' },
  { command: 'payments', path: '/payments', aliases: ['payments', 'paiements'], label: 'Open payments' },
  { command: 'messages', path: '/messages', aliases: ['messages', 'sms'], label: 'Open messages' },
