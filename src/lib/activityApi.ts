...
export const EVENT_TYPE_LABELS: Record<string, { en: string; fr: string; icon: string }> = {
  ...
  quote_created: { en: 'Quote created', fr: 'Devis créé', icon: 'file-text' },
  quote_sent: { en: 'Quote sent', fr: 'Devis envoyé', icon: 'send' },
  quote_approved: { en: 'Quote approved', fr: 'Devis approuvé', icon: 'check' },
  quote_declined: { en: 'Quote declined', fr: 'Devis refusé', icon: 'x' },
  quote_changes_requested: { en: 'Changes requested', fr: 'Modifications demandées', icon: 'edit' },
  quote_converted: { en: 'Quote converted', fr: 'Devis converti', icon: 'arrow-right' },
  ...
  job_updated: { en: 'Job updated', fr: 'Travail modifié', icon: 'edit' },
  ...
  invoice_updated: { en: 'Invoice updated', fr: 'Facture modifiée', icon: 'edit' },
