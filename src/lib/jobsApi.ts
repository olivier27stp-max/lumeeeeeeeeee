...
function mapJob(raw: any, clientNameFallback?: string | null): Job {
  return {
    ...
    deposit_type: raw.deposit_type === 'percentage' || raw.deposit_type === 'fixed' ? raw.deposit_type : null,
    deposit_value: raw.deposit_value == null ? 0 : Number(raw.deposit_value),
    deposit_cents: raw.deposit_cents == null ? 0 : Number(raw.deposit_cents),
    require_payment_method: raw.require_payment_method === true,
