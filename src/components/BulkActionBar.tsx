...
function BulkActionBar({ count, actions, onAction, onClear, language }: BulkActionBarProps) {
  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex items-center gap-2 bg-primary text-white rounded-xl shadow-2xl px-4 py-2.5">
        {/* Count */}
            ...
            className={cn(
              ...
              action.variant === 'danger'
                ...
                : action.variant === 'primary'
                  ? 'hover:bg-surface-card/20 text-white'
                  : 'hover:bg-surface-card/10 text-white/80',
        ...
        <button
          onClick={onClear}
          className="p-1.5 rounded-lg hover:bg-surface-card/10 text-white/60 transition-colors"
