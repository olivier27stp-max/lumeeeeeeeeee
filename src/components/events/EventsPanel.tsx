...
const EVENT_COLORS: Record<string, string> = {
  ...
  invoice_updated: 'bg-blue-100 text-blue-600',
  ...
  quote_changes_requested: 'bg-amber-100 text-amber-600',
  quote_converted: 'bg-green-100 text-green-600',
  job_created: 'bg-neutral-100 text-neutral-600',
  job_updated: 'bg-neutral-100 text-neutral-600',
