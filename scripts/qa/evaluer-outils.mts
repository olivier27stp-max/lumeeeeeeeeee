...
const CAS: Array<{ outil: string; q: string; voisins?: string[] }> = [
  ...
  { outil: 'update_automation_message', q: 'Change le texte du courriel de mon automatisation de rappel de rendez-vous : « Petit rappel, on passe demain ! »', voisins: ['list_automations'] },
  { outil: 'update_automation_sms_body', q: 'Change juste le texto de mon automatisation de rappel de rendez-vous pour « Rappel : on passe demain. »', voisins: ['list_automations'] },
