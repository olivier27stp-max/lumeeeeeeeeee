...
// ══════════════════════════════════════════════════════════════════════
//
// ⚠️  MIRROR OF web `src/lib/permissions.ts` — DO NOT FORK.
// The mobile app reuses the exact same roles, scopes and permissions as the
// desktop/web app. Keep this file byte-for-byte in sync with the web copy so
// a technician/admin/sales_rep has identical rights on mobile and desktop.
// If you change permissions, change them in web first, then re-copy here.
